...
const (
	...
	nanoglyphDescription NewsletterDescription = `<em>` + NewsletterDescription(nanoglyphName) + `</em> is a weekly newsletter about software and technology written by <a href="https://brandur.org">Brandur</a>.`
